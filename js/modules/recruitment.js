  ...
  render: function (container) {
    const html = `
      ...
      <div class="tabs" style="margin-bottom: 24px;">
        <button class="tab-btn active" onclick="Recruitment.switchView('jobs', event)">Job Board</button>
        <button class="tab-btn" onclick="Recruitment.switchView('applicants', event)">Applicants</button>
        <button class="tab-btn" onclick="Recruitment.switchView('pipeline', event)">Pipeline</button>
      </div>
