const Employees = {
  ...
  parseCSV: function (file) {
    ...
    reader.onload = (e) => {
      ...
      container.innerHTML = `
        ...
        <button class="btn btn-primary" style="width:100%" onclick="window.tempCSVPreview = ${JSON.stringify(preview)}; Employees.importCSVData()">Import ${preview.length} Employees</button>
      `;
  ...
  importCSVData: function () {
    const data = window.tempCSVPreview;
