      ...
      <div class="grid-1-2" style="gap:20px;align-items:start;">
        ...
        <div class="card" style="min-height:600px;display:flex;flex-direction:column;">
          ...
          <div class="card-body" style="flex:1;background:#e2e8f0;padding:24px;overflow-y:auto;display:flex;justify-content:center;">
            ...
            <div id="letterPaper" style="background:#fff; width:100%; max-width:800px; padding:40px; box-shadow:0 10px 25px rgba(0,0,0,0.1); font-family:'Georgia',serif; color:#333; min-height:500px;">
              <div id="letterHeader" style="display:flex; justify-content:space-between; align-items:flex-end; border-bottom:2px solid var(--primary); padding-bottom:20px; margin-bottom:40px;">
                <div>
                  <h1 id="letterCompName" style="margin:0; font-size:1.5rem; color:var(--primary); font-family:'Inter',sans-serif; text-transform:uppercase;">COMPANY</h1>
                  <div class="meta" style="font-size:0.75rem; color:var(--gray-500); font-family:'Inter',sans-serif; margin-top:4px;">Official Communication</div>
                </div>
                <div id="letterCompEmail" style="font-size:0.8rem; color:var(--gray-600); font-family:'Inter',sans-serif;">hr@company.com</div>
              </div>
              <div id="letterBody"></div>
              <div id="letterFooter" style="margin-top:60px; padding-top:20px; border-top:1px solid var(--gray-200); display:flex; justify-content:space-between; font-family:'Inter',sans-serif; font-size:0.8rem; color:var(--gray-500);">
                <span>Confidential</span>
                <span>Generated by Nexa HR</span>
              </div>
            </div>
          </div>
        </div>
...
window.renderLetterGenerator = c => LetterGenerator.render(c);
